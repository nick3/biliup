                ...
                <Form.InputNumber
                    ...
                    extraText={
                        <div style={{ fontSize: "14px" }}>
                            ...
                            <br />
                            可选项：30000（杜比），20000（4K），10000（原画），401（蓝光 - 杜比），400（蓝光），250（超清），150（高清），80（流畅），0（B 站默认，多数情况下是蓝光
                            400）
                        </div>
                    }
                    label="画质等级（bili_qn）"
                ...
                <Form.Input
                    ...
                    extraText={
                        <div style={{ fontSize: "14px" }}>
                            ...
                            」 提供的公用反代API。
                            <br />
                            如果海外机到联通或者移动网络线路还不错，就可以参考「哔哩哔哩 CND 列表」选取一些联通或者移动的节点并填入下面，每次会随机返回填入的其中一个线路，并且会自动判断所填入的节点是否可用。
                        </div>
                    }
                ...
                <Form.Input
                    ...
                    extraText={
                        <div style={{ fontSize: "14px" }}>
                            ...
                            <br />
                            大陆机器玩法：哔哩哔哩直播 API（bili_liveapi）使用官方
                            API，并将哔哩哔哩直播回退 API（bili_fallback_api）设置为能获取到海外节点
                    ...
                    label="哔哩哔哩直播回退 API（bili_fallback_api）"
                    style={{ width: "100%" }}
                    fieldStyle={{
                        alignSelf: "stretch",
                        padding: 0,
                ...
                <Form.Select
                    ...
                    extraText={
                        <div style={{ fontSize: "14px" }}>
                            哔哩哔哩直播流协议。
                            <br />
                            仅国内 IP 可以解析到 fmp4 流。海外 IP 只能获取到 FLV
                            流（ov05 与 ov07）和 ts 流（ov105）。
                            <br />
                            由于 fmp4
                            出现需要一定时间，或者某些小主播（大部分只有原画选项的主播）无 fmp4 流。
                            目前的策略是，如果开播时间小于 60s，将会反复尝试获取
